...
class LeafAndSpine(Topo):
    def __init__(self, spine=4, leaf=4, fanout=2, **opts):
        ...
        self.addLink(leafs[0], spines[0], **linkopts)
        self.addLink(leafs[0], spines[1], **linkopts)
        self.addLink(leafs[3], spines[2], **linkopts)
        self.addLink(leafs[3], spines[3], **linkopts)

        self.addLink(spines[0], spines[2], **linkopts)
        self.addLink(spines[1], spines[3], **linkopts)
